...
int64_t estimate_ann_build_memory(const AnnBuildMemoryParams& params, int64_t total_rows,
    ...
    const int64_t buffer_bytes = buffered_rows * dim * static_cast<int64_t>(sizeof(float));
    const int64_t store_bytes = total_rows * per_row_store_bytes(params);
    ...
    case AnnBuildMemoryParams::IndexKind::HNSW: {
        ...
        structure_bytes =
                static_cast<int64_t>(total_rows * degree * kHnswEdgeBytes * kHnswGraphFactor);
        break;
    }
